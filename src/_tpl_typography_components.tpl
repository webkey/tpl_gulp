@@if(context.component === "breadcrumbs") {

	@@include('_tpl_breadcrumbs.tpl', {
		"last": "Типографика в вебдизайне. Основные понятия и положения"
	})
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "textStyle",
		"taText": "Начертания шрифта"
	})

	<!--italic-->
	@@include('_tpl_title-anchor.tpl', {
		"taId": "textStyleItalic",
		"taText": "Наклонный",
		"taTag": "h4"
	})
	...
	<!--bold italic-->
	@@include('_tpl_title-anchor.tpl', {
		"taId": "textStyleBoldItalic",
		"taText": "Наклонный жирный",
		"taTag": "h4"
	})
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "file",
		"taText": "Документы для скачивания"
	})
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "formElementExample",
		"taText": "Поля форм"
	})
	<div class="layout-text">
		@@include('_tpl_forms_form-default.tpl')
	</div>
	...
	<div class="layout-text">
		@@include('_tpl_forms_form-selects.tpl')
	</div>

}@@if(context.component === "checkboxRadio") {

	@@include('_tpl_title-anchor.tpl', {
		"taId": "formCheckboxExample",
		"taText": "Чекбоксы и Радиобаттоны"
	})
	<div class="layout-text">
		@@include('_tpl_forms_checkbox-and-radio.tpl')
	</div>

}@@if(context.component === "userForm") {

	@@include('_tpl_title-anchor.tpl', {
		"taId": "userFormExample",
		"taText": "Форма обратной связи"
	})
	@@include('_tpl_forms_user-form.tpl', {
		"title": "Задать вопрос"
	})
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "imagesAlign",
		"taText": "Выравнивание картинок в контенте"
	})
	<div class="layout-text">
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "imagesCarousel",
		"taText": "Карусель с подписями"
	})
	@@include('_tpl_sliders_images-carousel.tpl')

}@@if(context.component === "searchPage") {

	@@include('_tpl_title-anchor.tpl', {
		"taId": "searchPage",
		"taText": "Пример страницы поиска"
	})
	<div class="layout-text">
	...
	@@include('_tpl_title-anchor.tpl', {
		"taId": "visualList",
		"taText": "Изображения + описания к ним"
	})
	<div class="layout-text">
		@@include("_tpl_feature-list.tpl")
	</div>

}@@if(context.component === "printButton") {
